...
// Validamos que exista una session y ademas que el cargo que exista sea igual a 1 (Usuario)
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item">
							<a href="../view/user/user.php" class="collapsed" aria-expanded="false">
																...
																<td>
																	<?php if ($va['estado_reservacion'] == 1) { ?>
																		<form method="get" action="javascript:activo('<?php echo $va['reservacion_id']; ?>')">
																			<span type="submit" class="btn btn-success btn-xs">Aceptado</span>
																		</form>
																	<?php  } else { ?>
																		<form method="get" action="javascript:inactivo('<?php echo $va['reservacion_id']; ?>')">
																			<span type="submit" class="btn btn-warning btn-xs">Pendiente</span>
																		</form>
																	<?php  } ?>
																</td>
																<td>
																	...
																	<?php  } else { ?>
																		<form method="get" action="javascript:inactivo_evento('<?php echo $va['reservacion_id']; ?>')">
																			<span type="submit" class="btn btn-danger btn-xs">No realizado</span>
																		</form>
																	<?php  } ?>
																</td>
