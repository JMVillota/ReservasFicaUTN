										...
										<div class="row mt-3">
											<div class="col-md-4">
												<div class="form-group form-group-default">
													<label>Nombre</label>
													<input type="text" class="form-control" value="<?php echo $d->Nombre; ?>" name="dnipa" placeholder="DNI" placeholder="77764664">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group form-group-default">
													<label>Apellido</label>
													<input type="email" class="form-control" value="<?php echo $d->Apellido; ?>" name="Nombrep" placeholder="Nombre">
												</div>
											</div>
										</div>
										<div class="row mt-3">
											<div class="col-md-4">
												<div class="form-group form-group-default">
													<label>Usuario</label>
													<input type="text" class="form-control" value="<?php echo $d->Usuario; ?>" name="apellidop" placeholder="Apellido">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group form-group-default">
													<label>Cargo</label>
													<input type="text" class="form-control" value="<?php echo $d->Cargo_Id; ?>" name="apellidop" placeholder="Apellido">
											...
											<div class="col-md-4">
												<div class="form-group form-group-default">
													<label>Correo</label>
													<input type="text" class="form-control" value="<?php echo $d->Correo; ?>" name="tele" placeholder="Phone">
												</div>
											</div>
										</div>
