...
!(function(t) {
    ...
    function O(t, e) {
        var n = t.oFeatures,
            a = n.bFilter;
        n.bSort && yt(t),
            a ? G(t, t.oPreviousSearch) : (t.aiDisplay = t.aiDisplayMaster.slice()), !0 !== e && (t._iDisplayStart = 0),
            (t._drawHold = e),
            k(t),
            (t._drawHold = !1);
    }
        ...
        for (var i, l, s, u, c, f, d = e.sDom.split(""), h = 0; h < d.length; h++) {
            if (((i = null), "<" == (l = d[h]))) {
                if (((s = t("<div/>")[0]), "'" == (u = d[h + 1]) || '"' == u)) {
                    ...
                    "H" == c ? (c = n.sJUIHeader) : "F" == c && (c = n.sJUIFooter), -1 != c.indexOf(".") ?
                        ((u = c.split(".")),
            ...
            var c,
                ...
                w = function(t, n) {
                    var o,
                        ...
                        p,
                        h = function(a) {
                            a.preventDefault(), !e(a.currentTarget).hasClass("disabled") &&
